...
<details>
  ...
  <ol>
    <li>
      <a href="#engine-swap-overview">Engine Swap Overview</a>
      <ul>
        <li><a href="#general-info">General Information</a></li>
        <li><a href="#boost-brothers-kit">Boost Brothers Kit</a></li>
        <li><a href="#engine-installation-guide">Engine Installation Guide</a></li>
      </ul>
    </li>
    <li>
      <a href="#accessories">Accessories</a>
      <ul>
        <li><a href="#accessory-bracket">Accessory Bracket</a></li>
    ...
    <li>
      ...
      <ul>
        <li><a href="#bellhousing">Bellhousing</a></li>
        <li><a href="#clutch">Clutch</a></li>
        <li><a href="#flywheel">Flywheel</a></li>
        <li><a href="#throwout-bearing">Throwout Bearing</a></li>
      </ul>
    </li>
    <li>
      <a href="#fuel-system">Fuel System</a>
      <ul>
        <li><a href="#fuel-injectors">Fuel Injectors</a></li>
        <li><a href="#fuel-rail">Fuel Rail</a></li>
        <li><a href="#fuel-regulator">Fuel Regulator</a></li>
        <li><a href="#fuel-pump">Fuel Pump</a></li>
        <li><a href="#fuel-lines">Fuel Lines</a></li>
      </ul>
    </li>
    <li>
      <a href="#ignition">Ignition System</a>
      <ul>
        <li><a href="#coil-packs">Coil Packs</a></li>
      </ul>
    </li>
    <li>
      <a href="#turbo-system">Turbo System</a>
      <ul> 
        <li><a href="#turbo">Turbo</a></li>
        <li><a href="#exhaust-manifold">Exhaust Manifold</a></li>
        <li><a href="#wastegate">Wastegate</a></li>
        <li><a href="#exhaust-system">Exhaust System</a></li>
        <li><a href="#intercooler">Intercooler</a></li>
        <li><a href="#intake-manifold">Intake Manifold</li>
        <li><a href="#intake-piping">Intake Piping</a></li>
      </ul>
    </li>
    <li>
      <a href="#cooling-system">Cooling System</a>
      <ul>
        <li><a href="#thermostat-housing">Thermostat Housing</a></li>
        <li><a href="#rear-outlet">Rear Outlet</a></li>
        <li><a href="#adapter-block-(Coolant)">Adapter Block (Coolant)</a></li>
        <li><a href="#cooling-Routing">Cooling Routing</a></li>
        <li><a href="#radiator">Radiator</a></li>
      </ul>
    </li>
    <li>
      <a href="#oiling-system">Oiling System</a>
      <ul>
        <li><a href="#adapter-block-(oil)">Adapter Block (Oil)</a></li>
        <li><a href="#oil-pan">Oil Pan</a></li>
        <li><a href="#oil-cooler">Oil Cooler</a></li>
        <li><a href="#oil-routing">Oil Routing</a></li>
      </ul>
    </li>
    <li><a href="#contact">Contact</a></li>
    <li><a href="#acknowledgments">Acknowledgments</a></li>
    <li><a href="#completed-swap-users">Directory of Completed Swaps</a></li>
  </ol>
</details>
